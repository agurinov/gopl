...
func TestDispatcher_Failed(t *testing.T) {
	...
	require.ElementsMatch(t, dispatcher.AllKeys(), allKeys)
...
func TestDispatcher(t *testing.T) {
	...
	require.ElementsMatch(t, dispatcher.AllKeys(), []int32{1, 5})

	dispatcher.Stop(1)
	require.ElementsMatch(t, dispatcher.Running(), []int32{5})
	require.ElementsMatch(t, dispatcher.AllKeys(), []int32{5})

	dispatcher.Stop(5)
	require.ElementsMatch(t, dispatcher.Running(), noKeys)
	require.ElementsMatch(t, dispatcher.AllKeys(), noKeys)
}

...
const (
	...
	KafkaConsumerNotMyRecordCounterName            = "gopl_kafka_consumer_not_my_record_cnt"
	...
	KafkaConsumerCooldownDurationHistogramName     = "gopl_kafka_consumer_cooldown_duration_seconds"
)

func newConsumerMetrics() consumerMetrics {
	return consumerMetrics{
		notMyRecord: metrics.NewCounter(
			KafkaConsumerNotMyRecordCounterName,
